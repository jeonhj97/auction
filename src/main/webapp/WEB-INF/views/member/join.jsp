...
<div class="main">  
   ...
   <!-- 회원가입 -->
        <div class="joinWrap">
            ...
            xans-element- xans-member xans-member-join page-join = joinWrap
            ec-base-table = j
            "ec-base-table typeWrite" = "jtypeWrite"
            "ec-base-table typeWrite " = "jtypeWrite2"
         -->
                <div class="jtypeWrite">
                    <table border="1">
                ...
                <div class="jtypeWrite2">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="tooltip">
                                    <input id="passwd" name="passwd" fw-filter="isFill&amp;isMin[4]&amp;isMax[16]" fw-label="비밀번호" autocomplete="off" maxlength="16" 0="disabled" type="password">
                                    <div class="tooltip_typeUpper" style="display: none">
                                        <div class="tooltip_typeUpper_content">
                                            <strong class="txtWarn">※ 비밀번호 입력 조건</strong>
                                            <ul class="txtWarn_content">
                                                - 대소문자/숫자 4자~16자<br> - 특수문자 및 공백 입력 불가능 </ul>
                                        </div>
        ...
        <tr>
            ...
            <td><input id="user_passwd_confirm" name="user_passwd_confirm" fw-filter="isFill&amp;isMatch[passwd]" fw-label="비밀번호 확인" fw-msg="비밀번호가 일치하지 않습니다." autocomplete="off" maxlength="16" 0="disabled" value="" type="password">
                <span id="pwConfirmMsg"></span> </td>
                            ...
                            <tr>
                                ...
                                <td><select id="mobile1" name="mobile[]" fw-filter="isNumber&amp;isFill" fw-label="휴대전화" fw-alone="N">
    ...
    <option value="019">019</option>
    </select>-<input id="mobile2" name="mobile[]" maxlength="4" fw-filter="isNumber&amp;isFill" fw-label="휴대전화" fw-alone="N" type="text">-<input id="mobile3" name="mobile[]" maxlength="4" fw-filter="isNumber&amp;isFill" fw-label="휴대전화" fw-alone="N" type="text">
                            ...
                            <tr>
                                ...
                                <td><input id="email1" name="email1" fw-filter="isFill&amp;isEmail" fw-label="이메일" fw-alone="N" type="text"> <span id="emailMsg"></span>
                                </td>
                            </tr>
                ...
                <div class="ec-base-box agreeArea  ">
                    ...
                    <p class="check" id="marketing-check">
                        <li class="">
                            <span>마케팅 정보 수신에 동의하십니까?</span> <label for="sms_check"><input id="check1" class="ab" name="sms_check" fw-label="is_sms" fw-msg="" class="ec-base-chk" value="T" type="checkbox">동의함</label> </li>
                        <!-- <li class="">
                ...
                <div class="btnJoinMain">
                    <div id="btnJoin" class="btnJoin">
                        <a href="#none" class="btnNormal wide sizeM" id="join-submit">회원가입</a>
                    </div>
                </div>
            </div>
